            ...
            <div className="rounded-2xl border border-black/10 bg-white p-6 shadow-sm md:p-7">
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                <button
                  ...
                  className="rounded-full border border-black/10 bg-black/5 px-5 py-2.5 text-sm font-semibold text-neutral-700 transition hover:bg-black/10 hover:text-neutral-900"
                >
                ...
                <a
                  ...
                  className="rounded-full border border-black/10 bg-black/5 px-5 py-2.5 text-sm font-semibold text-neutral-700 no-underline transition hover:bg-black/10 hover:text-neutral-900"
                >
                  LinkedIn
                </a>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="rounded-full border border-blue-600/30 bg-blue-600/10 px-5 py-2.5 text-sm font-semibold text-blue-600 no-underline transition hover:bg-blue-600/20"
                >
                  Download Resume
                </a>
              </div>
